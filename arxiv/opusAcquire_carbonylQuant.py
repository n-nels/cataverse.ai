...
def CheckInstrumentStatus():
    ...
    if (arr[0] == 'OK'):
        ...
        if (number == 0):
            ...
            return True
        if (number == 3):
            print("Instrument warnings and alarms present. Measurements are possible.\n")
            return True
...
repeat = [10] # number of times to repeat
delay = [60] # delay (s) between repeats

nss_value = 256

do_bckg = 1 # 0 for yes, 1 for no

main('NN2031_04PdCe_13_quant_Ar', 'NN2031_04PdCe_COAds') # sample name, folder name
