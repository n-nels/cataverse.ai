...
def main_tpd(sample_name, folder_name):
    print("\nStart of program...")
    ...
    for i in range(len(delay)):
        for k in range(repeat[j]):
            ...
            try:
                ...
                print('\nSpectrum ' + str(k) + ' of ' + str(repeat[j]) + ' for ' +
...
# # PRIMARY
# repeat = [10, 5, 15, 1000] # number of times to repeat
...
# main('NN2053_04PdCe_5', 'NN2053_04PdCe_COAds') # sample name, folder name


# # QUANTIFICATION
# repeat = [24] # number of times to repeat
# delay = [300] # delay (s) between repeats
# nss_value = 256

# do_bckg = 1 # 0 for yes, 1 for no

# main('NN2031_04PdCe_139', 'NN2031_04PdCe_COAds') # sample name, folder name


# MISCELLANEOUS
# repeat = [1000] # number of times to repeat
# delay = [3600] # delay (s) between repeats

# nss_value = 256

# do_bckg = 1 # 0 for yes, 1 for no

# main('20241118_100026_pd_ceo2_000-002', 'nn1120-2_pd_ceo2_000') # sample name, folder name


# # TPD
# repeat = [110] # number of times to repeat
# delay = [10] # delay (s) between repeats
# nss_value = 16

# do_bckg = 1 # 0 for yes, 1 for no

# main_tpd('NN2031_04PdCe_116_evac', 'NN2031_04PdCe_COAds') # sample name, folder name

# files = glob.glob(path_OpusFiles + '\\' + SampleName + ".*")  # unload all
# call the tpd_postProcess here


# TEST
repeat = [3] # number of times to repeat
delay = [15] # delay (s) between repeats
nss_value = 1
