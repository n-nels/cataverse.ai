...
## Current goal (as of 2026-08-07)
Ship the minimum: navigate to cataverse.ai → see and interact with the graph. Done, running locally. Not yet deployed.
Vision/goals/agent sections of spec.md are deferred until after this works in production.
...
4. Deploy to Vercel (free tier) — next
5. DNS: cataverse.ai is registered with Cloudflare (Nick will log in there); point records at Vercel AFTER deploy exists
