...
class IsotopicExchangeCalibration:
    ...
    def supply_gas_to_mfld(self, gas: str, targetPressure: float) -> None:
        ...
        from src.core.config import v_m1m2m3, v_50tube, v_tot
    ...
    def supply_another_gas_to_mfld(self, gas: str, targetPressure: float) -> None:
        ...
        from src.core.config import v_m3, v_m1m2, v_50tube, v_tot
        from src.physics import cell_pressure_from_manifold

        self.p_cell_calc = cell_pressure_from_manifold(self.p_mfld, v_m3, v_tot)
        self.p_cell_calc_2 = cell_pressure_from_manifold(
            self.p_mfld_2, v_m1m2 + v_50tube, v_tot
        )
    ...
    def acquire_spectra(
        ...
        pressure_thread = threading.Thread(
            target=self.gas_controller.pressure_log,
            args=(self.session.path_pressure_log, stop_pressure_log, p_mfld, p_cell),
        )
    ...
    def chiller_variac_state(
        ...
        self.temp.kasa_plug_state(chiller_id, chiller_cmd)
        self.temp.kasa_plug_state(variac_id, variac_cmd)
    ...
    def copy_readme(self) -> None:
        ...
        from src.core.config import share_drive_peak_fit_root
