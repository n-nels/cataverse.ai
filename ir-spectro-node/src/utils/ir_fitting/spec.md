...
**Current experiment status:** §14.19 records the previous lower-split
five-anchor run. It is historical, not the active configuration. The current
experiment is the uncut full-ROI three-anchor versus seven-anchor comparison in
§14.20; no production recommendation or default changed.
